...
#training
model = elm.elm(hidden_units=2000, activation_function='sigmoid', random_type='normal', x=x_train, y=y_train, C=0.1, elm_type='clf')
...
pickle.dump(model, open(model_name, 'wb')) #save the machine learning model
